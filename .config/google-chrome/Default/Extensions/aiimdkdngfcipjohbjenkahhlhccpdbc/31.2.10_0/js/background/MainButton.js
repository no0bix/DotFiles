	...
	(function(){
		...
		var MainButton = function(){
			...
			function setMainButtonStatus(can, tabId){
				...
				switch (can ) {
					case 0: img = chrome.extension.getURL('images/fvd.single.cant_download.png');  break;
					case 1: img = chrome.extension.getURL('images/fvd.single.can_download.png');  break;
					case 2: img = chrome.extension.getURL('images/fvd.single.downloading.png');  break;
					case 3: img = chrome.extension.getURL('images/fvd.single.recording.png');  break;
				}	
