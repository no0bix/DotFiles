define(["exports", "meta"], function (_exports, meta) {
  ...
  */
  ...
  var slide = function slide(anime
  /*: Function*/
  , direction
  /*: 'up' | 'down'*/
  , element
  ...
  /*: Object*/
  {
    ...
    if (direction === 'up') {
      ...
      element.style.cssText = ['border-top-width', 'border-bottom-width', 'padding-top', 'padding-bottom', 'height'].reduce(function (carry, property) {
        return carry + "".concat(property, ":0px;");
  ...
  _exports.$slideDefault = slide;
  var slide$1 = {
    default: slide
  }; // @flow

  _exports.$slide = slide$1;
  var template = html(_templateObject_a64fa8405b8f11e9b4dd99419b6c54c8());
  ...
  */
  ...
  (function () {
    ...
    Object.assign(translations, imageTranslations);
    ...
    function (_PolymerElement) {
      ...
      function MainBlock() {
        ...
        return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(MainBlock).apply(this, arguments));
      }
      ...
      babelHelpers.createClass(MainBlock, [{
        ...
        value: function ready() {
          ...
          babelHelpers.get(babelHelpers.getPrototypeOf(MainBlock.prototype), "ready", this).call(this); // All nodes with image replacement

          Array.from(this.shadowRoot.querySelectorAll('[data-role="with image"]')).forEach(function (element) {
            var text
            /*: string*/
            = element.textContent.trim();
            var parts
            /*: Array<Array<Node>>*/
            = text.split('IMG').map(function (text, index) {
            ...
            var nodes
            /*: Array<Node>*/
            = _.flatten(parts); // Removing all nodes inside element
          ...
          var objects
          /*: Array<SectionObject>*/
          = Array.from(this.shadowRoot.querySelectorAll('[data-role="section"]')).map(function (element, index) {
            var elements
            /*: SectionElements*/
            = {
              'parent': element,
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      otherIndexes
                      /*: Array<integer>*/
                      = _.without(indexes, index).filter(function (index) {
                      ...
                      promises.push(babelHelpers.asyncToGenerator(
                      /*#__PURE__*/
                        ...
                        return regeneratorRuntime.wrap(function _callee2$(_context2) {
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                _context2.next = 2;
                                return slide(window.anime, currentObject.visible ? 'up' : 'down', currentObject.elements.information, {
                                  'duration': 700,
                                  'easing': 'linear'
                                }).finished;
                              ...
                              case 2:
                                if (currentObject.visible) {
                                  currentObject.elements.parent.classList.remove('open');
                                } else {
                                  currentObject.elements.parent.classList.add('open');
                                }
