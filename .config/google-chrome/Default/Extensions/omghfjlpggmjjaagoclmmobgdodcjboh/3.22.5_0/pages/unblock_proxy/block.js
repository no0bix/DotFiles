define(["exports", "meta"], function (_exports, meta) {
  ...
  */
  ...
  _exports.html$1 = _exports.html = html;
  ...
  var templatize$1 = {
    ...
    modelForElement: _modelForElement,
  ...
  function (_domRepeatBase) {
    ...
    function DomRepeat() {
      ...
      _this12 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(DomRepeat).call(this));
      _this12.__instances = [];
      _this12.__limit = Infinity;
      _this12.__pool = [];
      _this12.__renderDebouncer = null;
      _this12.__itemsIdxToInstIdx = {};
      _this12.__chunkCount = null;
      _this12.__lastChunkTime = null;
      _this12.__sortFn = null;
      _this12.__filterFn = null;
      _this12.__observePaths = null;
      /** @type {?function(new:Polymer.TemplateInstanceBase, *)} */

      _this12.__ctor = null;
      _this12.__isDetached = true;
      _this12.template = null;
      return _this12;
    }
    /**
     * @override
    ...
    babelHelpers.createClass(DomRepeat, [{
      ...
      value: function disconnectedCallback() {
        ...
        for (var _i21 = 0; _i21 < this.__instances.length; _i21++) {
          this.__detachInstance(_i21);
        }
      }
      /**
       * @override
      ...
      value: function connectedCallback() {
        ...
        if (this.__isDetached) {
          ...
          for (var _i22 = 0; _i22 < this.__instances.length; _i22++) {
            this.__attachInstance(_i22, parent);
          }
        }
      }
    }, {
      ...
      value: function __ensureTemplatized() {
        ...
        if (!this.__ctor) {
          ...
          if (!_template3) {
            // // Wait until childList changes and template should be there by then
            var observer = new MutationObserver(function () {
              if (_this13.querySelector('template')) {
                observer.disconnect();
          ...
          this.__ctor = templatize(_template3, this, {
            ...
            forwardHostProp: function forwardHostProp(prop, value) {
              ...
              for (var _i23 = 0, inst; _i23 < i$.length && (inst = i$[_i23]); _i23++) {
            ...
            notifyInstanceProp: function notifyInstanceProp(inst, prop, value) {
              if (matches(this.as, prop)) {
                ...
                var _path2 = translate(this.as, 'items.' + idx, prop);

                this.notifyPath(_path2, value);
              }
            }
          });
        }
      ...
      value: function __handleObservedPaths(path) {
        ...
        if (this.__sortFn || this.__filterFn) {
          if (!path) {
            ...
            for (var _i24 = 0; _i24 < paths.length; _i24++) {
              if (path.indexOf(paths[_i24]) === 0) {
                this.__debounceRender(this.__render, this.delay);
              }
            }
          }
      ...
      value: function __applyFullRefresh() {
        ...
        for (var _i25 = 0; _i25 < items.length; _i25++) {
          isntIdxToItemsIdx[_i25] = _i25;
        } // Apply user filter


        if (this.__filterFn) {
          isntIdxToItemsIdx = isntIdxToItemsIdx.filter(function (i, idx, array) {
            return _this15.__filterFn(items[i], idx, array);
          });
        } // Apply user sort
        ...
        if (this.__sortFn) {
          isntIdxToItemsIdx.sort(function (a, b) {
            return _this15.__sortFn(items[a], items[b]);
          });
        ...
        for (var _i26 = this.__instances.length - 1; _i26 >= instIdx; _i26--) {
          this.__detachAndRemoveInstance(_i26);
        }
      }
    }, {
      ...
      value: function __detachInstance(idx) {
        ...
        for (var _i27 = 0; _i27 < inst.children.length; _i27++) {
          var el = inst.children[_i27];
      ...
      value: function _showHideChildren(hidden) {
        for (var _i28 = 0; _i28 < this.__instances.length; _i28++) {
          this.__instances[_i28]._showHideChildren(hidden);
        }
  ...
  _exports.$log = log$1;
  var template = html(_templateObject_aad1fc105b8f11e9b4dd99419b6c54c8());
  _exports.$blockTemplateDefault = template;
  var blockTemplate = {
    default: template
  }; // @flow
  ...
  */
  ...
  var proxyDisableBrokenMode =
  /*#__PURE__*/
  function () {
    var _ref = babelHelpers.asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee() {
      var _ref2, success, errorData, message, error;
    ...
    return function proxyDisableBrokenMode() {
  ...
  (function () {
    ...
    var Browser = backgroundPage.Browser;
    ...
    function (_PolymerElement2) {
      babelHelpers.inherits(MainBlock, _PolymerElement2);
      babelHelpers.createClass(MainBlock, null, [{
        key: "template",
        get: function get() {
          return template;
        }
        ...
        get: function get() {
          return {
            'contactSupportUrl': {
              'type': String,
              'computed': 'computeContactSupportUrl(pageLinks)'
            },
            'extensions': {
              'type': Array,
              'value': []
      ...
      function MainBlock() {
        ...
        _this16 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(MainBlock).call(this));
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  ...
                  /** @method */
                  _this16.browsecLink = function (url
                  /*: string*/
                  )
                  /*: string*/
                  {
                ...
                case 6:
                  _this16.pageLinks = _context3.sent;
                  _this16.logoUrl = _this16.browsecLink('https://browsec.com/?utm_source=Chromium+extension&utm_medium=logo_link&utm_campaign=congratulations');
      ...
      babelHelpers.createClass(MainBlock, [{
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    babelHelpers.get(babelHelpers.getPrototypeOf(MainBlock.prototype), "ready", this).call(this);
                    _context4.next = 3;
        ...
        key: "comparison",
        value: function comparison(mode, value) {
          return mode === value;
        }
        /** @method */

      }, {
        key: "computeContactSupportUrl",
        value: function computeContactSupportUrl(pageLinks) {
          return pageLinks.contactUs ? this.browsecLink(pageLinks.contactUs) : '';
        } // Methods
        ...
        value: function () {
          var _disableExtensions = babelHelpers.asyncToGenerator(
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee5() {
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    extensions
                    /*: Array<ExtensionData>*/
                    = this.extensions.filter(function (_ref6) {
                  ...
                  case 10:
                    _context5.prev = 10;
                    _context5.next = 13;
                    return proxyDisableBrokenMode();

                  case 13:
                    this.mode = 'success'; // console.log( 'Unblock proxy page: setBooleanState -> success' );
                  ...
                  case 16:
                    ...
                    this.mode = 'error'; // console.log( 'error' );
                  ...
                  case 21:
                    ...
                    this.mode = 'error';
                    log.error('Unblock proxy error: ', _context5.t1); // nodes.warningBox.fadeOut( () => { nodes.errorBox.fadeIn(); });
            ...
            }, _callee5, this, [[7, 21], [10, 16]]);
          }));

          function disableExtensions() {
            return _disableExtensions.apply(this, arguments);
          }
        ...
        key: "extensionCheckbox",
        value: function extensionCheckbox(_ref8)
        /*: void*/
        {
          ...
          var index
          /*: integer*/
          = this.extensions.indexOf(extension);

          var extensions
          /*: Array<ExtensionData>*/
          = _$1.cloneDeep(this.extensions);
        ...
        key: "getExtensionsList",
        value: function () {
          var _getExtensionsList = babelHelpers.asyncToGenerator(
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    extensions
                    /*: Array<ExtensionData>*/
                    = data.reduce(function (extensions, _ref9) {
                      ...
                      if (!condition) return extensions;
                      var extension
                      /*: ExtensionData*/
                      = {
                        'checked': true,
                      ...
                      var iconUrl
                      /*: string | void*/
                      = _$1.get(icons[1] || icons[0], 'url');

                      if (iconUrl) {
                        extension.icon = "chrome://favicon/size/38/chrome-extension://".concat(id, "/");
                      }
          ...
          function getExtensionsList() {
            return _getExtensionsList.apply(this, arguments);
          }
        ...
        key: "scanExtensions",
        value: function () {
          var _scanExtensions = babelHelpers.asyncToGenerator(
          /*#__PURE__*/
                        ...
                        return regeneratorRuntime.wrap(function _callee7$(_context7) {
                          while (1) {
                            switch (_context7.prev = _context7.next) {
                              ...
                              case 2:
                                if (_this17.mode !== 'information') _this17.mode = 'information';
                                _this17.hasManagement = true;

                                _this17.getExtensionsList();
          ...
          function scanExtensions() {
            return _scanExtensions.apply(this, arguments);
          }
